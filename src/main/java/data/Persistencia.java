...
public class Persistencia {
    ...
    private static void inicializarVehiculos(){
        ...
        VehiculoElectrico v1 = new VehiculoElectrico("Francia","AE123FG", "Renault", "Kangoo E-Tech", 2020, 1000, s1, 16);
        VehiculoElectrico v2 = new VehiculoElectrico("EEUU","AF456HI", "Ford", "E-Transit", 2021, 1300, s2, 16);

        VehiculoCombustible v3 = new VehiculoCombustible("Italia","AC789JK", "Iveco", "Daily", 2023, 1200, s1, 8, 1.5);
        VehiculoCombustible v4 = new VehiculoCombustible("Alemania","AD321LM", "Mercedes", "Sprinter", 2020, 1200, s2, 7, 1);
