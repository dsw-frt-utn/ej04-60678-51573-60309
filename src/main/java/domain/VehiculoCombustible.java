...
public class VehiculoCombustible extends Vehiculo {
    ...
    public VehiculoCombustible(String pais, String patente, String marca, String modelo, int anio, double capacidadCarga,
                               Sucursal sucursal, double kilometrosPorLitro, double litrosExtra) {
        super(pais, VehiculoTipo.COMBUSTIBLE, patente, marca, modelo, anio, capacidadCarga, sucursal);
